...
################################################################################
# Traffic Signal Analysis - Stage 1B
#
...
#
# Output directories:
#   traffic_signal_analysis_results/   - JSON result files (suffix: _traffic_signal.json)
################################################################################
...
# Output directories
RESULTS_DIR="traffic_signal_analysis_results"
...
echo "================================================================================"
echo "Traffic Signal Analysis - Stage 1B"
echo "================================================================================"
...
# Run the module
python3 -m nuscenes_pipeline.modules.traffic_signal_analysis \
    --start_idx $START_IDX \
    --end_idx $END_IDX \
...
echo ""
echo "================================================================================"
echo "Traffic signal analysis complete!"
echo "  Results:  $RESULTS_DIR/"
echo "================================================================================"
